...
SYSTEM_PROMPT = """You are a recruitment assistant. Given a job_id, return the top 3 best-matching candidates from the database using the available tools.
...
USER_PROMPT_TEMPLATE = "For {job_id}, find the top 3 best matching candidates."

FORCE_FINAL_PROMPT = (
    "You have run out of exploration budget. Based on what you have already "
    "learned via tool calls, return your best top-3 ranked candidates as JSON "
    "in the schema specified in the system prompt. Do not call any more tools."
)
